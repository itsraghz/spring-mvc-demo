	...
	<div id="contacts" class="container">
		...
		<div class="row">
			<div class="col-12" align="center">
				<div class="alert alert-danger" role="alert">No Contact
					available with the id you supplied!</div>
			</div>
		</div>
		<%
		} else {
		...
		<a href="update-contact?id=${contact.id}" class="btn btn-info"
			role="button">Update</a> <a href="delete-contact?id=${contact.id}"
			class="btn btn-danger" role="button">Delete</a> <a href="contacts"
			class="btn btn-primary">View All Contacts</a>
	</div>
